        ...
        <div class="auth-card">
          ...
          <form @submit.prevent="login" class="auth-form">
            ...
            <div class="form-group">
              ...
              <input id="login-email" type="email" v-model="email" placeholder="your@email.com" required :disabled="isSubmitting" />
            </div>
            ...
            <div class="form-group">
              ...
              <div class="input-password">
                <input id="login-password" :type="showPassword ? 'text' : 'password'" v-model="password" placeholder="Mật khẩu" required :disabled="isSubmitting" />
...
.toggle-pw {
  ...
  background: none; border: none; cursor: pointer; color: #a0a8c0; display: flex; padding: 4px; transition: color 0.2s;
}
...
.btn-social {
  display: flex; align-items: center; justify-content: center; gap: 8px; padding: 11px; border: 1.5px solid #e0e4ec; border-radius: 10px; background: #fff; font-size: 0.85rem; font-weight: 500; font-family: inherit; color: #333; cursor: pointer; transition: background 0.2s, border-color 0.2s;
}
