...
<template>
    <main class="home-main">
        ...
        <section class="banner-section animate-in">
            <img
                src="http://localhost:8383/storage/banners/banner_1.png"
                alt="banner"
            ...
            <div class="banner-content">
                ...
                <h1 class="banner-title text-white">
                    Phong Cách<br />Thời Thượng
                </h1>
                <p class="banner-desc fs-5 text-white">
                    Định hình cá tính của bạn với bộ sưu tập thời trang mới
                    nhất. <br />
                    Thiết kế tối giản, dễ mặc, dễ phối cho mọi lứa tuổi.
                </p>
                <button class="btn-primary btn-large mt-5">
                    Mua sắm ngay ->
                </button>
            </div>
        </section>
        ...
        <section class="promo-section animate-in" style="animation-delay: 0.2s">
            <div class="promo-banner ocean-card">
                <div class="promo-text">
                    ...
                    <p>
                        Sở hữu ngay những items hot nhất với mức giảm lên đến
                        <strong>50%</strong>. Giao hàng miễn phí toàn quốc cho
                        đơn từ 500.000đ.
                    </p>
